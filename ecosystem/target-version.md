# Target Version — accepted full target of the forge stack

Version: 1.0.0 · Ratified: 2026-07-03 · Machine version: [`target-version.v1.json`](target-version.v1.json) (validated against [`specs/harness/stack-target-version.v0.1.schema.json`](specs/harness/stack-target-version.v0.1.schema.json) by the spec-contracts gate)
...
- **Static publication**: Dioxus SSG for forge products; the Astro exception ended with the cos rebuild decision (DA-2a).
