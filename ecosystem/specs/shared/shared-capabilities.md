...
| Export package | `rumble-lm`, `rumble-canvas`, `rumble-cos` | Gear Depot artifact + Rumble UX | Accepted | Audience-scoped export becomes an `ArtifactRef`/`ArtifactManifest`; Rumble owns export UX and included data semantics. |
...
| Evidence report | `rumble-canvas`, `rumble-crew`, `rumble-cos`, `rumble-lm`, Bolt gates, CI | `wrench-inspect` | Candidate | Shared report model for API/browser/eval/clean-room evidence: findings, verdicts, traces, redactions, hashes, and `ArtifactRef` handoff to Gear. Introduced by ADR 0022 as repo hardening, not a new repo. |
| Browser evidence collector | Interactive Rumbles, `rumble-cos`, CI, portal verification | `wrench-inspect` | Candidate | Sandboxed browser diagnostics: rendering, console, network, accessibility, screenshots, and visual proof. Must use disposable profiles, allowlists, and secret redaction. |
...
| Spec package | `rumble-canvas`, later `rumble-cos`, `rumble-lm`, `rumble-note` exports | Gear Depot artifact + Rumble UX | Accepted | Immutable bundle of approved revisions is a Gear artifact; Canvas owns spec semantics and approval workflow. |
