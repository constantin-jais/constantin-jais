# ADR-0035 — Agentic P0 tooling backlog for stack validation

- Status: Accepted
- Date: 2026-07-02
- Renumbered from ADR-0025 on 2026-07-03 (numbering-collision repair, DA-3 / ADR 0033); content unchanged.
- Related: `0034-stack-validation-local-only.md`, `../decision-log.md`, `../../harness/04-stack-validation-tooling.md`
