...
| Is AGPL acceptable, or must the project relicense / receive a documented waiver? | High | Product/Legal | Open |
| Is the current Rust backend + Expo client target still desired, or should it converge with interactive Rumble stack decisions? | High | Architecture | Open |
