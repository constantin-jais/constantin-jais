...
| `constantin-jais` | Control plane / profile repo | KEEP | 1 | 0 | 0 | MIT | `constantin-jais` | MIT license detected; governance policy check/apply is green. |
...
No public open PR remains after the 2026-07-07 governance pass.
