...
| `libre-ai/portal` | infrastructure | keep canonical | four imported histories, adapters, forge and template |
...
| --- | --- | --- |
| Portal sources (4) | archived | complete — histories, checks and consumers verified in `libre-ai/portal` |
