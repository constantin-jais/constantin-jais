...
| 2b   | cos rebuild on Dioxus SSG (+ cos-matic dogfooding pilot)                    | `rumble-cos/docs/plans/2026-07-cos-rebuild-dioxus-ssg.md`                                               | I1-I5 delivered; retargeted to **libre-ia.fr** (Libre IA brand v2, 2026-07-10; `/blog` path unchanged); I6-I14 remaining                          |
