...
| M2 — Biscuit real chain (mint↔verify)            | partial     | D11 prerequisites recorded (Canvas fixture #5, LM mapping #51); cos-matic real verify still stub; wire after first slice                           | ADR 0029/0036; `delegated-authorization-biscuit.v0.1` |
...
| ------------------------------------------ | ---------- | --------------------------------------------------------------------------------------- | --------------------------- |
| rumble-lm — session runtime + DoD slice    | partial    | workspace-identity mapping done (#51); runtime still fixture-first; **chosen first vertical** (2026-07-04) | ADR 0029; remaining-work 2a |
