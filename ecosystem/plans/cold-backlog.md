...
| M2 — Biscuit real chain (mint↔verify)            | partial     | Canvas D11 fixture merged (#5, deterministic tenant-scoped mock); cos-matic real verify still stub; wire after first slice                          | ADR 0029/0036; `delegated-authorization-biscuit.v0.1` |
