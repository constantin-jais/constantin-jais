...
| `rumble-mail` product                                | rumble      | cold        | Product ratification **+ M1** (identity)                                                                                             | `odysseus-decomposition.md` product cards; `rumble-mail-cal-decomposition.md` |
| `rumble-cal` product                                 | rumble      | cold        | Product ratification **+ M1**; paired with rumble-mail                                                                               | `odysseus-decomposition.md` product cards; `rumble-mail-cal-decomposition.md` |
...
| ------------------------------------------------ | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| M1 — workspace-identity contract + schema        | **partial** | contract + control-plane schema **Accepted 2026-07-04**; **canvas emission of `tenant_id` + local-schema re-sync still pending** (so not fully done) | ADR 0028; `workspace-identity.v0.1`                   |
