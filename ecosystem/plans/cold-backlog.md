...
| `rumble-mail` product                                | rumble      | cold        | Product ratification **+ M1** (identity)                                                                                             | `odysseus-decomposition.md` product cards                                     |
| `rumble-cal` product                                 | rumble      | cold        | Product ratification **+ M1**; paired with rumble-mail                                                                               | `odysseus-decomposition.md` product cards                                     |
